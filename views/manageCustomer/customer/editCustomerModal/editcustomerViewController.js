 ...
 */
export async function displayeditCustomerContent(htlmPartId, customerID) {
    let editModal = null;
    try {
        // *** Get customer
        ...
        let editModaleString = `
            <div class="container" >
                <div class="modal fade" id="myModalEditCustomer" role="dialog" data-bs-backdrop="static"
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h5 class="modal-title" style="color:#8B2331">Edit customer</h5>
        ...
        // });
        // document.querySelector("#editCustomer").addEventListener("keypress",  function (event) {

        // *** Initialisation
        $(document).ready(function () {
            editModal = new bootstrap.Modal(document.querySelector("#myModalEditCustomer"))
...
function displayCustomerIdentity(customer, customerOrders) {
    ...
    output += `
        <dob-bloctitlev2 blocIcon ="bi-person" blocName = "Customer Identity" >
