 ...
 */
export async function startComponentController() {
    ...
    try {
        ...
        if (searchParams.has('componentID'))
            displayOrderContent("mainActiveSection", searchParams.get('componentID'));
 ...
 */
export async function displayComponentContent(htlmPartId, componentID) {
